# 🟢 How to START the App (Start of Day)
Assuming your computer was off and you are starting fresh:
...
(If you didn't delete the cluster yesterday, skip this. The cluster usually pauses and wakes up with Docker).
...
🔄 How to UPDATE the App (The Dev Loop)
This is the most important part. If you change code (e.g., fix a typo in app.js), it will not update automatically. You must follow this cycle:
